...
int Cola<T>::Buscar(string Nom)
{
    ...
    if(a == 0)
    {
        cout<<"No hay solicitud de alumno, dar de alta la solicitud\n";
        int i=-1;
        return i;
    }
}
...
int main()
{
    ...
    do
    {
        ...
        cout<<"2.-Crear  constancia: \n";
        cout<<"3.-Buscar una solicitud : \n";
        cout<<"4.-Salir: \n";
        ...
        case 3:
            ...
            if(pos!=-1)
            {
                cout<<"\n\nLa solicitud esta en la posicion: "<<pos;
                cout<<"\n\n La solicitud en la posicion "<<pos<<" necesita hacer una constancias antes para poder elaborar la solicitud";
            }
            break;
        case 4:
            break;
